...
|*preferSuggestedFont* |Override font selection or default system fonts. _Currently only used for Urdu Nastaliq_ |No |
...
The *keymap* object contains the rules that control key and character assignments in _Key Curry_
